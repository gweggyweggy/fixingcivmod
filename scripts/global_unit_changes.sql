...
--might remove/adjust the last 2 civic boosters as they are really just meant for the memes
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES 
	...
	('SIXFIX_MASS_MEDIA_MONK_ADJUST_STRENGTH', 'MODIFIER_UNIT_ADJUST_BASE_COMBAT_STRENGTH', 'PLAYER_HAS_MASS_MEDIA'),
	('SIXFIX_PROFESSIONAL_SPORTS_MONK_ADJUST_STRENGTH', 'MODIFIER_UNIT_ADJUST_BASE_COMBAT_STRENGTH', 'PLAYER_HAS_PROFESSIONAL_SPORTS')
	;
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
	('SIXFIX_THEOLOGY_MONK_ADJUST_STRENGTH', 'Amount', 5), --now 40 str
	('SIXFIX_REFORMED_CHURCH_MONK_ADJUST_STRENGTH', 'Amount', 15), --now 55
	('SIXFIX_MASS_MEDIA_MONK_ADJUST_STRENGTH', 'Amount', 10), --now 65
	('SIXFIX_PROFESSIONAL_SPORTS_MONK_ADJUST_STRENGTH', 'Amount', 10) --now 75
	;
...
INSERT INTO Requirements (RequirementId, RequirementType) VALUES
	('REQUIRES_SIXFIX_PLAYER_HAS_MASS_MEDIA','REQUIREMENT_PLAYER_HAS_CIVIC');
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
	('PLAYER_HAS_MASS_MEDIA', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
	('PLAYER_HAS_MASS_MEDIA', 'REQUIRES_SIXFIX_PLAYER_HAS_MASS_MEDIA');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
	('REQUIRES_SIXFIX_PLAYER_HAS_MASS_MEDIA','CivicType','CIVIC_MASS_MEDIA');

INSERT INTO Requirements (RequirementId, RequirementType) VALUES
	('REQUIRES_SIXFIX_PLAYER_HAS_PROFESSIONAL_SPORTS','REQUIREMENT_PLAYER_HAS_CIVIC');
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES
	('PLAYER_HAS_PROFESSIONAL_SPORTS', 'REQUIREMENTSET_TEST_ALL');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES
	('PLAYER_HAS_PROFESSIONAL_SPORTS', 'REQUIRES_SIXFIX_PLAYER_HAS_PROFESSIONAL_SPORTS');
INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES
	('REQUIRES_SIXFIX_PLAYER_HAS_PROFESSIONAL_SPORTS','CivicType','CIVIC_PROFESSIONAL_SPORTS');
...
INSERT INTO UnitAbilities(UnitAbilityType, Name, Description) VALUES
	('ABILITY_SIXFIX_MASS_MEDIA_MONK_ADJUST_STRENGTH', 'LOC_ABILITY_SIXFIX_MASS_MEDIA_MONK_BONUS_NAME', 'LOC_ABILITY_SIXFIX_MASS_MEDIA_MONK_BONUS_DESC');
INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
	('ABILITY_SIXFIX_MASS_MEDIA_MONK_ADJUST_STRENGTH', 'SIXFIX_MASS_MEDIA_MONK_ADJUST_STRENGTH');
INSERT INTO Types (Type, Kind) VALUES 
	('ABILITY_SIXFIX_MASS_MEDIA_MONK_ADJUST_STRENGTH','KIND_ABILITY');
INSERT INTO TypeTags (Type, Tag) VALUES 
	('ABILITY_SIXFIX_MASS_MEDIA_MONK_ADJUST_STRENGTH','CLASS_WARRIOR_MONK');

INSERT INTO UnitAbilities(UnitAbilityType, Name, Description) VALUES
	('ABILITY_SIXFIX_PROFESSIONAL_SPORTS_MONK_ADJUST_STRENGTH', 'LOC_ABILITY_SIXFIX_PROFESSIONAL_SPORTS_MONK_BONUS_NAME', 'LOC_ABILITY_SIXFIX_PROFESSIONAL_SPORTS_MONK_BONUS_DESC');
INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
	('ABILITY_SIXFIX_PROFESSIONAL_SPORTS_MONK_ADJUST_STRENGTH', 'SIXFIX_PROFESSIONAL_SPORTS_MONK_ADJUST_STRENGTH');
INSERT INTO Types (Type, Kind) VALUES 
	('ABILITY_SIXFIX_PROFESSIONAL_SPORTS_MONK_ADJUST_STRENGTH','KIND_ABILITY');
INSERT INTO TypeTags (Type, Tag) VALUES 
	('ABILITY_SIXFIX_PROFESSIONAL_SPORTS_MONK_ADJUST_STRENGTH','CLASS_WARRIOR_MONK');
