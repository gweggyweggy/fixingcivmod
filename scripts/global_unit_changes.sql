...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES 
	('SIXFIX_THEOLOGY_MONK_BONUS', 'MODIFIER_PLAYER_UNITS_ATTACH_MODIFIER', NULL),
	('SIXFIX_THEOLOGY_MONK_ADJUST_STRENGTH', 'MODIFIER_UNIT_ADJUST_BASE_COMBAT_STRENGTH', NULL)
	;
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
	('SIXFIX_THEOLOGY_MONK_BONUS', 'ModifierId', 'SIXFIX_THEOLOGY_MONK_ADJUST_STRENGTH'),
	('SIXFIX_THEOLOGY_MONK_ADJUST_STRENGTH', 'Amount', 20)
...
INSERT INTO UnitAbilities(UnitAbilityType, Name, Description) VALUES
	('ABILITY_SIXFIX_THEOLOGY_MONK_BONUS', 'LOC_ABILITY_SIXFIX_THEOLOGY_MONK_BONUS_NAME', 'LOC_ABILITY_SIXFIX_THEOLOGY_MONK_BONUS_DESC');
INSERT INTO UnitAbilityModifiers (UnitAbilityType, ModifierId) VALUES
	('ABILITY_SIXFIX_THEOLOGY_MONK_BONUS', 'SIXFIX_THEOLOGY_MONK_BONUS');
INSERT INTO Types (Type, Kind) VALUES 
	('ABILITY_SIXFIX_THEOLOGY_MONK_BONUS','KIND_ABILITY');
INSERT INTO TypeTags (Type, Tag) VALUES 
	('ABILITY_SIXFIX_THEOLOGY_MONK_BONUS','CLASS_WARRIOR_MONK');

--having abilities apply as a trait to all
INSERT INTO Traits (TraitType) VALUES 
	('TRAIT_SIXFIX_THEOLOGY_MONK_BONUS');
INSERT INTO Types (Type, Kind) VALUES 
	('TRAIT_SIXFIX_THEOLOGY_MONK_BONUS','KIND_TRAIT');
INSERT INTO TraitModifiers (TraitType, ModifierId) VALUES 
	('TRAIT_SIXFIX_THEOLOGY_MONK_BONUS', 'GRANT_ABILITY_SIXFIX_THEOLOGY_MONK_BONUS');
INSERT INTO Modifiers (ModifierId, ModifierType) VALUES 
	('GRANT_ABILITY_SIXFIX_THEOLOGY_MONK_BONUS', 'MODIFIER_PLAYER_UNITS_GRANT_ABILITY');
INSERT INTO ModifierArguments (ModifierId, Name, Value) VALUES 
	('GRANT_ABILITY_SIXFIX_THEOLOGY_MONK_BONUS', 'AbilityType', 'ABILITY_SIXFIX_THEOLOGY_MONK_BONUS');
